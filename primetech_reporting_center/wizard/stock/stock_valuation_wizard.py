...
class StockValuationWizard(
    models.TransientModel
):
    _name = "pt.stock.valuation.wizard"

    _description = (
        "PrimeTech Stock Valuation Wizard"
    )
    ...
    def action_preview(
        ...
        html = self.env[
            ...
            "primetech_reporting_center.stock_valuation_preview_template",
        ...
        preview = self.env[
            ...
            "pdf_report_ref":
                "primetech_reporting_center.action_stock_valuation_pdf",

            "xlsx_report_ref":
                "primetech_reporting_center.action_stock_valuation_xlsx",
